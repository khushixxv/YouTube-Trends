...
for country in ['BR', 'CA', 'DE', 'FR', 'GB', 'IN', 'JP', 'KR', 'MX', 'RU', 'US']:
    ...
    df = df[["video_id", "title", "view_count", "trending_date"]]
...
for name, group in grouped:
    ...
    fig.update_layout(
        title="Video Life Cycle Analysis - VIEWS",
        xaxis_title="Day Trending",
        yaxis_title="Rate of Change in Views",
...
fig.write_html('static/lifecycle_views.html')